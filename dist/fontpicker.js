...
var onKeyPress = (e) => {
  ...
  if (e.key === "Enter") {
    ...
    const first = fonts2.find((f) => !f.classList.contains("hide-s") && !f.classList.contains("hide-c") && !f.classList.contains("hide-l") && f.dataset.family.toLowerCase().startsWith(e.key));
    if (first) {
      selectFont(first);
